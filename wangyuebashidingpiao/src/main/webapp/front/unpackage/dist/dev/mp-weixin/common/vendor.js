...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.uploadMedia = exports.upload = exports.recommend = exports.detail = exports.info = exports.del = exports.update = exports.save = exports.add = exports.list = exports.page = exports.session = exports.resetPass = exports.register = exports.login = exports.auth = exports.requestMap = exports.aaaaa = exports.requestConditionData = exports.requestCondition = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ./http */ 14));
...
var requestCondition = function requestCondition(tableName, functionName, value) {
  var data = null;
  if (value.length > 0) {
    for (var i = 0; 1 < value.length; i++) {
      if (value[i] == 0) {
        data = "?" + value[i].key + "=" + value[i].val;
      } else {
        data += "&" + value[i].key + "=" + value[i].val;
      }
    }
...
var aaaaa = function aaaaa(tableName, functionName, data) {
  return _http.default.request({
    url: "".concat(tableName, "/").concat(functionName, "?").concat(data.key, "=") + data.val,
    method: 'GET' });
...
};exports.uploadMedia = uploadMedia;var _default =
{
  ...
  save: save, // 保存
  upload: upload, // 上传
  aaaaa: aaaaa };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var base = {
  url: "http://localhost:8080/wangyuebashidingpiao/" };var _default =
