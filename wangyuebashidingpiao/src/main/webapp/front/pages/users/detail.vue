		...
		<view class="container">
            <view class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
					...
					<view class="text" :style='{"color":"rgba(84, 170, 111, 1)","textAlign":"center","fontSize":"24rpx"}'>{{detail.username}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(84, 170, 111, 1)","textAlign":"left"}'>密码：</view>
					<view class="text" :style='{"color":"rgba(84, 170, 111, 1)","textAlign":"center","fontSize":"24rpx"}'>{{detail.password}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"rgba(84, 170, 111, 1)","textAlign":"left"}'>角色：</view>
					<view class="text" :style='{"color":"rgba(84, 170, 111, 1)","textAlign":"center","fontSize":"24rpx"}'>{{detail.role}}</view>
				</view>
