    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分" prop="yonghuNewJifen">
                       <el-input v-model="ruleForm.yonghuNewJifen"
                                 placeholder="积分" clearable  :readonly="ro.yonghuNewJifen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="积分" prop="yonghuNewJifen">
                           <el-input v-model="ruleForm.yonghuNewJifen"
